    ...
    <>
      ...
      <header className="sticky top-0 z-50 bg-neutral-50">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-2 lg:gap-4 p-3 ">
          <img src="img/logo-proyecto.webp" alt="Logo" className="rounded-full max-w-24" />
          <div className="cursor-default">
            <span className="block text-xl">Proyecto San Francisco de Asís</span>
            <span className="block text-sm">Salud y servicio para la comunidad</span>
          </div>
          <Nav links={links} />
        </div>
      </header>
      ...
      <footer className="bg-neutral-900 text-white mt-5">
        <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="titulo-footer">Ubicación</h3>
            <p className="text-neutral-400">Reitoca, Francisco Morazán, Honduras</p>
          </div>
          <div>
              <h3 className="titulo-footer">Enlaces rápidos</h3>
          ...
          <div>
            <h3 className="titulo-footer">Apoyo</h3>
